...
(setq doom-font (font-spec :family "Noto Sans Mono" :size 14)
      ;; doom-serif-font (font-spec :family "NotoSerif Nerd Font Mono" :size 14)
      ;; doom-variable-pitch-font (font-spec :family "NotoSerif Nerd Font" :size 14)
      doom-variable-pitch-font (font-spec :family "Gentium Plus" :size 14)
      doom-unicode-font (font-spec :family "Adishila" :size 42))
      ;; doom-unicode-font (font-spec :family "AnnapurnaSIL-Regular" :size 24))
